...
import { name as dashboardName, reducer as dashboardReducer } from "@src/screens/debitcard";
...
export type ReduxStore = EnhancedStore<CombinedState<State>, AnyAction, Middleware<SagaMiddleware>[]>;
